...
export default function FormPetani() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log(data);
        post(route("pelatihan.petani.store"), {
            forceFormData: true,
        });
    };
        ...
        <Form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <SelectKecamatan
                                onChange={(item) =>
                                    setData((prevState) => ({
                                        ...prevState,
                                        kode_kecamatan_kelompok: item.id,
                                        nama_kecamatan_kelompok: item.text,
                                    }))
                                }
                                errors={errors.nama_kecamatan_kelompok}
                            />
                        </div>
                        <div className="col-md-6 col-12 mb-3">
                            <Form.Label className="required">
                            ...
                            <SelectKelurahan
                                kodeKecamatan={data.kode_kecamatan_kelompok}
                                onChange={(item) =>
                                    setData((prevState) => ({
                                        ...prevState,
                                        kode_kelurahan_kelompok: item.id,
                                        nama_kelurahan_kelompok: item.text,
                                    }))
                                }
                                errors={errors.nama_kelurahan_kelompok}
                            />
                        </div>
                    </Form.Group>
                    <Form.Group className="row mb-1">
                        <div className="col-md-6 col-12 mb-3">
                            <Form.Label className="required">RW</Form.Label>
                            <SelectRw
                                kodeKelurahan={data.kode_kelurahan_kelompok}
                                onChange={(item) =>
                                    setData((prevState) => ({
                                        ...prevState,
                    ...
                    <Form.Group className="row mb-1">
                        <div className="col-md-12 col-12 mb-3">
                            ...
                            <Form.Control
                                onChange={(e) =>
                                    setData("alamat_kelompok", e.target.value)
                                }
                                as="textarea"
                                rows="3"
                                value={data.alamat_kelompok}
                                isInvalid={errors.alamat_kelompok}
                                autoComplete="alamat_kelompok"
                                placeholder="Alamat KTP (Jalan/Gang/Lingkungan/No rumah)"
                            />
                            <Form.Control.Feedback type="invalid">
                                {errors.alamat_kelompok}
                            </Form.Control.Feedback>
                        </div>
                    </Form.Group>
                            ...
                            {data.jenis_kategori == 1 ? (
                                <SelectJenisPelatihanPetani1
                                    ...
                                    onChange={(item) =>
                                        setData({
                                            ...data,
                                            jenis_pelatihan_petani: item.id,
                                        })
                                    }
            ...
            {!dataPenerima && errorMessage && (
                <div className="alert alert-warning mt-3">
                    ...
                    KELOMPOK TANI. INFO LEBIH LANJUT KIRIM WA KE{" "}
