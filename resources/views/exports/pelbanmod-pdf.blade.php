...
<head>
    ...
    <title>Peserta Pelatihan Penerima Bantuan Modal DBHCHT </title>
    <style>
        @page {
            size: landscape;
            margin: 1cm;
...
<body>
    <div class="header">
        <h4 style="margin: 0;">DAFTAR PESERTA PELATIHAN PENERIMA BANMOD KOTA KEDIRI</h4>
